...
- The same **14-day recovery window** applies from the moment your request is registered: signing back in during that window restores your account and cancels the deletion. After 14 days, the deletion is permanent.

## What is permanently deleted

After the 14-day recovery window, the following data linked to your account is permanently deleted:

- Your profile (email address, display name, languages, and level)
- Your song library links
- Your favorites
- Your saved vocabulary
- Your study history
- Your activity data (listening time, streaks, daily activity)
...
Some data is kept after your account is deleted, for the following reasons:

- **Transaction and purchase records** — retained where legally required (tax and bookkeeping law).
- **Anonymized technical logs and an anonymized deletion-statistics snapshot** — kept without any link to your identity.
- **Shared song content (audio, lyrics, cover art)** — songs are deduplicated, shared content that is not owned by any single account, so they may remain in the catalog. Your personal link to them (library entry, favorites, vocabulary) is deleted.
- **Purchase data held by Apple, Google, and RevenueCat** — governed by their own privacy policies. You can request deletion from them directly.
